      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Container(
              margin:
                  EdgeInsets.only(left: Sizes.dimen_24, right: Sizes.dimen_24),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  Container(
                    ...
                    child: Text(
                      'Nike Air Jordan X',
                      style: headlineStyle.copyWith(fontSize: Sizes.dimen_20),
                    ),
                  ),
                  Row(
                    children: [
                      ...
                      Text(
                        ' (130 Reviewers)',
                        style:
                            contentDarkBlueNormal.copyWith(color: Colors.grey),
                      ),
                    ],
                  ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          height: 21,
                          margin: EdgeInsets.only(
                              left: Sizes.dimen_10, right: Sizes.dimen_10),
                          decoration: BoxDecoration(
                    ...
                    Container(
                      margin: EdgeInsets.symmetric(vertical: Sizes.dimen_16),
                      child: Row(
                        children: [
                          Expanded(
                            flex: 10,
                    ...
                    Container(
                      margin: EdgeInsets.only(top: Sizes.dimen_30),
                      height: 64,
                      width: MediaQuery.of(context).size.width,
