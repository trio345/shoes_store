  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.only(left: Sizes.dimen_24, top: Sizes.dimen_24),
          child: Text(
            'Perfect Shoes',
            style: headlineStyle,
          ),
        ...
        Container(
          padding: EdgeInsets.only(
              left: Sizes.dimen_24, top: Sizes.dimen_4, bottom: Sizes.dimen_24),
          child: Text(
            'For perfect style',
              ...
              Expanded(
                ...
                child: TextButton(
                  style: TextButton.styleFrom(
                    minimumSize: Size(Sizes.dimen_48, Sizes.dimen_48),
